...
165 entries: 15 open, 1 partial, 0 blocked, 149 done. Every P0 is done.
The open entries are [T-1321](image.md) through [T-1332](cli.md), and
...
operator-ordered `man` verb, after T-1112, T-1315 through T-1320 and
