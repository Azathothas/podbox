...
165 entries: 12 open, 1 partial, 0 blocked, 152 done. Every P0 is done.
The open entries are [T-1324](complete.md) through [T-1332](cli.md), and
...
operator-ordered `man` verb, after T-1112, T-1315 through T-1322 and
