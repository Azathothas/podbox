...
165 entries: 16 open, 1 partial, 0 blocked, 148 done. Every P0 is done.
The open entries are [T-1320](image.md) through [T-1332](cli.md), and
[T-1334](packaging.md) through [T-1336](cli.md): what remains of the
2026-09-23 triage from nineteen client-filed issues plus the
operator-ordered `man` verb, after T-1112, T-1315, T-1316, T-1317, T-1318,
T-1319 and T-1333 closed below. The
