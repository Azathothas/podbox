...
165 entries: 14 open, 1 partial, 0 blocked, 150 done. Every P0 is done.
The open entries are [T-1322](image.md) through [T-1332](cli.md), and
...
operator-ordered `man` verb, after T-1112, T-1315 through T-1321 and
