...
| **Fixing a defect** | [`methodology/authoring.md`](docs/methodology/authoring.md) , the code the defect is in , [`conventions/forbidden-patterns.md`](docs/conventions/forbidden-patterns.md) |
| **Taking a measurement** | [`methodology/experiments.md`](docs/methodology/experiments.md) , an existing script in `experiments/` as the shape |
| ⭐ **Adding or changing a check in the gate** | [`methodology/gate.md`](docs/methodology/gate.md) , then `scripts/plant.sh`. ⛔ A check and its plant land in the same change |
| **Studying an external repository** | [`methodology/references.md`](docs/methodology/references.md) , [`TODO/reference-map.md`](TODO/reference-map.md) |
| ⭐ **Touching any vendored or third-party source** | [`methodology/vendoring.md`](docs/methodology/vendoring.md) , [`THIRD_PARTY.md`](THIRD_PARTY.md) . ⛔ Patch it here, and upstreaming is not a topic |
| **Writing or editing a document** | [`conventions/prose.md`](docs/conventions/prose.md) , [`conventions/docs.md`](docs/conventions/docs.md) |
| **Committing** | [`conventions/git.md`](docs/conventions/git.md) |
| **Anything crossing a shell, or a quoting problem** | [`conventions/shell.md`](docs/conventions/shell.md) |
| **Touching anything remote** | [`security/remote-ops.md`](docs/security/remote-ops.md) |
| **Anything involving a credential** | [`security/secrets.md`](docs/security/secrets.md) |
| **Recording something superseded** | [`methodology/history.md`](docs/methodology/history.md) . ⛔ Not into the page it supersedes |
| **Changing the adopted work model** | [`methodology/work-todo.md`](docs/methodology/work-todo.md) , [`methodology/authoring.md`](docs/methodology/authoring.md) . podbox has one work model |
| **Closing out a session** | [`methodology/sessions.md`](docs/methodology/sessions.md) , [`methodology/reviews.md`](docs/methodology/reviews.md) |
...
| [`references/`](references/) | the corpus: pinned trees with their trackers. Read once, under `docs/methodology/references.md` |
...
| [`docs/`](docs/) | ⛔ the methodology plus project architecture, history, and operating references. **Binding, not advisory.** Imported material is identified in `THIRD_PARTY.md` |
...
[`conventions/shell.md`](docs/conventions/shell.md) and both worth naming twice:
...
The current template checks, doctor scripts, public-document guidance, line
ending policy, commit hook, dependency updates, and read-only remote-item
workflow are present. The imported methodology therefore has no accepted dead
links. `scripts/common/check-markers.sh` and its PowerShell twin are adapted to
exclude only `references/`, because the corpus is immutable third-party text;
project-owned documents remain in scope. [`THIRD_PARTY.md`](THIRD_PARTY.md)
records the imported revisions and adaptations.
