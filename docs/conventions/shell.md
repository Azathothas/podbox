...
- ⛔ **`[int]` on a double rounds.** Casting the double `2.65` to `[int]`
  produces 3, so a 2h39m session prints as 3h39m and the number goes straight
  into a report. Use `[math]::Floor`.
