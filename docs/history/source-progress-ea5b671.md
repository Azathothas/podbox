...
machine whose bare `chown` gets `EPERM`. ⭐ [T-0709](../../TODO/interpose.md) is the reader
that decides which of the two objects a payload may load, and it refuses the
pair the loader refuses, from the ELF alone. ⭐ [T-0608](../../TODO/supervise.md) was
...
default returns error 60. [T-0412](../../TODO/complete.md) is where that was found and it
...
[T-0102](../../TODO/probe.md)'s correction, which the entry carries.
...
| the row that was podbox's, and what it was | `opensuse-leap`: libzypp reads a **hash-indexed CApath**, so a CAfile is invisible | the same, and [T-0412](../../TODO/complete.md) |
...
| ⭐ tcp/80 egress from this host | **works**, 200 in 0.104 s. ⛔ So T-0411's premise does not hold here | `curl`, recorded in [T-0411](../../TODO/complete.md) |
...
| ⭐ a blob body cut off mid-stream | retried, and the staging file **restarted** rather than appended to | [T-0214](../../TODO/image.md) |
...
[T-0702](../../TODO/interpose.md), not [T-0709](../../TODO/interpose.md) -- its clause 3 needs a
...
⭐ **Seven entries closed this session**: [T-0412](../../TODO/complete.md),
[T-0406](../../TODO/complete.md), [T-1106](../../TODO/milestones.md), [T-0214](../../TODO/image.md),
[T-0709](../../TODO/interpose.md), [T-0608](../../TODO/supervise.md) and [T-0701](../../TODO/interpose.md).
[T-0704](../../TODO/interpose.md) is `partial`: the wall is cleared and measured under both
...
[T-0710](../../TODO/interpose.md) and [T-0711](../../TODO/interpose.md) are the two halves T-0704
left; [T-0808](../../TODO/cli.md) is the check that would have caught the `create`
defect the door sweep found by hand; [T-1110](../../TODO/milestones.md) is M6's own
ten-row acceptance; and [T-1207](../../TODO/gate.md) is the crate the gate does not read.
...
`--populate` close [T-0406](../../TODO/complete.md)'s keyring half with the same mechanism.
...
[T-0704](../../TODO/interpose.md) is `partial` and not `done`.
...
waiting for in its own file: [T-0503](../../TODO/enter.md) a machine without a pty,
[T-0704](../../TODO/interpose.md) its `EINVAL` half and the identity fork,
[T-1109](../../TODO/milestones.md) the clause that needs a loadable interposer.
...
1. ⭐ **[T-0702](../../TODO/interpose.md), one object per libc, placed INSIDE the rootfs.**
   ...
   it anywhere or set `LD_PRELOAD`. [T-0709](../../TODO/interpose.md) is the selector it
...
2. **[T-0703](../../TODO/interpose.md), the entry-point set**, and the `*at` resolution
...
3. ⭐ **[T-1110](../../TODO/milestones.md), M6's acceptance**, in M5's shape: a payload the
...
4. **[T-0704](../../TODO/interpose.md) to `done`**: exercise the `EINVAL` arm. Its two
   remaining halves are entries now -- [T-0710](../../TODO/interpose.md) the memo's
   placement and its linear scan, [T-0711](../../TODO/interpose.md) the identity calls --
   and both carry a ruling the operator owns.
5. **[T-0805](../../TODO/cli.md)**, the four-part diagnostic: the operation, the errno, the
   mechanism and the remedy, with `TOOL.md` section 8's table as the mapping.
   [T-0102](../../TODO/probe.md)'s discriminator and [T-0105](../../TODO/probe.md)'s maps are its
   inputs, so it quotes measured state rather than guessing.
6. **[T-0808](../../TODO/cli.md)**, driving all 141 parity rows through the shipped binary.
   ...
   direction.
7. **[T-1207](../../TODO/gate.md)**, the crate the gate does not read.
...
8. **M7 packaging**, [T-1108](../../TODO/milestones.md) and [packaging.md](../../TODO/packaging.md).

⚠ [T-0606](../../TODO/supervise.md) stays `blocked` and is not in the order: `supervise`
has no read channel on the target and no way to be made race-safe if it had one.
[T-0909](../../TODO/deps.md) stays `blocked` on the same kind of thing.
...
1. **`/dev/ptmx` on the target**, and it is ⭐ **one command rather than a
   ...
   anyone who can reach it. The probe half of [T-0503](../../TODO/enter.md) is implemented
   ...
   table repeated back. ⚠ [T-0112](../../TODO/probe.md)'s virtual machine does not settle
...
2. ⭐ **Does the interposer's ownership memo belong inside the rootfs?** It is
   ...
   error. [T-0710](../../TODO/interpose.md) carries all three and its `Prove` is written
...
3. ⚠ **The identity half of ownership virtualization is an unruled fork.**
   ...
   [T-0711](../../TODO/interpose.md) carries it, and it says to measure the real
...
6. ⚠ **This machine intercepts TLS, and podbox propagates its announced CA
   ...
   [T-0412](../../TODO/complete.md) now **indexes** that bundle into the image's CApath as
...
- ⭐ **`podbox run -d` reading `exited` one second after starting a `sleep 20`.
  REPRODUCED and FIXED.** [T-0608](../../TODO/supervise.md), and the cause was neither of
  the two candidates the entry refused to act on.
- ⭐ **A kernel with Landlock. ANSWERED by building one.** [T-0112](../../TODO/probe.md):
...
- ⭐ **A kernel with `CONFIG_CHECKPOINT_RESTORE`. ANSWERED the same way**, and
  ...
  reading. [T-0102](../../TODO/probe.md).
- ⭐ **Whether tcp/80 hangs on this host. MEASURED, and it does NOT**: 200 in
  0.104 s. [T-0411](../../TODO/complete.md)'s premise is about the runtimes podbox targets
...
- ⭐ **The branch. SETTLED on 2026-09-09** and written into
  [RULES.md](../../TODO/RULES.md) section 2 with the cost it carried, so no session
...
- ⭐ **What `{{.Size}}` should report. ANSWERED BY MEASUREMENT**: docker 29.3.1
  ...
  content, equal to podbox's blob total to the byte. [T-0202](../../TODO/image.md).
